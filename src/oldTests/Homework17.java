...
public class Homework17 extends BaseTest {
    ...
    private void searchSong(String song) {
        WebElement searchField = BaseTest.driver.findElement(By.name("q"));
        searchField.clear();
        searchField.sendKeys(song);
    }

    private void clickOnLoginBtn() {
        WebElement loginButton = BaseTest.driver.findElement(By.xpath("//button[@type='submit']"));
        loginButton.click();
    }

    private void providePassword(String password) {
        WebElement passwordField = BaseTest.driver.findElement(By.xpath("//input[@type='password']"));
        passwordField.clear();
        passwordField.sendKeys(password);
    }

    private void provideEmail(String email) {
        WebElement emailField = BaseTest.driver.findElement(By.xpath("//input[@type='email']"));
        emailField.clear();
